                ...
                <div className="row">
                  ...
                  <div className="row__icon">
                    ...
                    <p>
                      ...
                      movement.With their help many traders determine the
                      relative position of the price within selected time
                      interval.
                    </p>
                    <i className="fa fa-exclamation-circle"></i>
                  </div>
                  ...
                  <div className="chat__row">
                    <div className="chat">
                      ...
                      <div className="chat__content">
                        <h6>Charles.J</h6>
                        <p>
                          If I were you I would consider the banking section.
                        </p>
                      </div>
                    </div>
                  </div>
